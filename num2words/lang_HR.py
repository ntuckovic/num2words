...
SCALE = {
    ...
    3: ('milijarda', 'milijarde', 'milijarda', True),  # 10^9
    4: ('bilijun', 'bilijuna', 'bilijuna', False),  # 10^12
    5: ('bilijarda', 'bilijarde', 'bilijarda', True),  # 10^15
    6: ('trilijun', 'trilijuna', 'trilijuna', False),  # 10^18
    7: ('trilijarda', 'trilijarde', 'trilijarda', True),  # 10^21
    8: ('kvadrilijun', 'kvadrilijuna', 'kvadrilijuna', False),  # 10^24
    9: ('kvadrilijarda', 'kvadrilijarde', 'kvadrilijarda', True),  # 10^27
    10: ('kvintilijun', 'kvinitilijuna', 'kvinitilijuna', False),  # 10^30
}
